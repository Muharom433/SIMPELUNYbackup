/*
  ...
  2. Security
    ...
    - Department admins can manage equipment in their department
    - Super admins can manage all equipment

  3. Sample Data
    - Insert various equipment items for testing
    - Include mandatory and optional equipment
    - Different categories: Audio Visual, Teaching Aid, Computing, etc.
