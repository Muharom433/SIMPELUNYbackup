...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div>
        {/* Hero Section */}
        <section className="relative min-h-screen bg-gradient-to-br from-amber-100 via-orange-200 to-amber-300 overflow-hidden">
          {/* Background Shape */}
          <div className="absolute inset-0">
            {/* Main diagonal shape */}
            <div 
              className="absolute top-0 right-0 w-full h-full bg-gradient-to-br from-orange-100 via-amber-200 to-orange-300 opacity-60"
              style={{
            ...
            <div 
              className="absolute top-0 right-0 w-4/5 h-full bg-gradient-to-br from-yellow-50 via-orange-100 to-amber-200 opacity-40"
              style={{
            ...
            {/* Light accent shape */}
            <div 
              className="absolute top-0 right-0 w-2/3 h-full bg-gradient-to-br from-orange-50 via-yellow-100 to-orange-200 opacity-20"
              style={{
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="text-amber-900 space-y-6">
                <div className="space-y-4">
                  ...
                  <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-amber-800">
                    Yogyakarta State University
                  </h2>
                  <p className="text-sm sm:text-base lg:text-lg text-amber-700 leading-relaxed max-w-lg">
