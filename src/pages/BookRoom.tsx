...
import { z } from 'zod';
import {
    Building, Plus, Search, Edit, Trash2, Eye, Users, MapPin, CheckCircle, AlertCircle, Clock, RefreshCw, X, List, Grid, Zap, Tv2, Speaker, Presentation, Mic, AirVent, Loader2, Hash, DoorClosed, Calendar as CalendarIcon, Phone, Send
} from 'lucide-react';
    ...
    const fetchRoomsWithStatus = useCallback(async () => {
        try {
            ...
            const roomsWithStatus = roomsData.map(room => {
                ...
                if (inUseRoomNames.has(normalizedRoomName)) { status = 'In Use'; } 
                else if (scheduledRoomNames.has(normalizedRoomName)) { status = 'Scheduled'; } 
