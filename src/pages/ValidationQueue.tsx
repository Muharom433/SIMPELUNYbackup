...
const ValidationQueue: React.FC = () => {
    ...
    useEffect(() => {
        ...
        if (showDetailModal && selectedCheckoutId) {
            ...
            // Fetch equipment details based on equipment_requested

            const selectedCheckout = checkouts.find(c => c.id === selectedCheckoutId);

            if (selectedCheckout?.booking?.equipment_requested) {
    ...
    }, [showDetailModal, selectedCheckoutId, checkouts]);
